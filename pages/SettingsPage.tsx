...
const SettingsPage: React.FC = () => {
    const { equipment, updateEquipment, addLogEntry, refreshInventory } = useApp();
    ...
    const handleUpload = async () => {
        ...
        reader.onload = async (e) => {
            ...
            try {
                const response = await fetch(`${baseUrl}/api/inventory/bulk-upload`, {
                    method: 'POST',
    ...
    return (
        <div className="pb-10">
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-md mb-8">
                <h2 className="text-xl font-semibold text-gray-700 dark:text-gray-100 mb-4 border-b dark:border-gray-700 pb-2">Carga Masiva de Inventario (CSV)</h2>
